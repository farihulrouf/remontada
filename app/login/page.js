                ...
                <div className="w-full flex">
                    <div className="sm:w-1/2 w-full">
                        ...
                        <div className="w-full bg-gray-200 flex flex-col p-24 mt-6 h-72 relative">
                            ...
                            <button className="bg-yellow-400 px-2 w-36 py-2 mt-2 mb-2 rounded-xl flex justify-center items-center space-x-3" onClick={matchREdirect}><label>Guess Now</label> <BsArrowRight size={24} /></button>
